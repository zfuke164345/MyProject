...
**
** Created: Thu Sep 11 10:05:16 2014
...
static const char qt_meta_stringdata_CommThread[] = {
    "CommThread\0"
};
...
const QMetaObjectExtraData CommThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CommThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CommThread,
      qt_meta_data_CommThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CommThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CommThread))
        return static_cast<void*>(const_cast< CommThread*>(this));
